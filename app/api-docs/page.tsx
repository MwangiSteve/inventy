      ...
      endpoints: [
        ...
        },
        {
          ...
          parameters: [
            ...
            { name: "family", type: "string", required: false, description: "Product family (e.g., Sufuria Family)" },
            { name: "weightClass", type: "string", required: false, description: "Weight class (Light|Medium|Heavy)" },
            { name: "size", type: "string", required: false, description: "Size (18,20,22,24)" },
            { name: "buyingPrice", type: "number", required: false, description: "Buying price" },
            { name: "sellingPrice", type: "number", required: true, description: "Selling price" },
            { name: "quantity", type: "number", required: true, description: "Product quantity" },
            { name: "lowStockAlert", type: "number", required: false, description: "Low stock alert threshold" },
            { name: "categoryId", type: "string", required: true, description: "Category ID" },
            { name: "supplierId", type: "string", required: false, description: "Supplier ID" }
          ],
          response: {
        ...
        },
        {
          ...
          parameters: [
            ...
            { name: "weightClass", type: "string", required: false, description: "Weight class" },
            { name: "size", type: "string", required: false, description: "Size" },
            { name: "buyingPrice", type: "number", required: false, description: "Buying price" },
            { name: "sellingPrice", type: "number", required: true, description: "Selling price" },
            { name: "quantity", type: "number", required: true, description: "Product quantity" },
            { name: "lowStockAlert", type: "number", required: false, description: "Low stock alert" },
